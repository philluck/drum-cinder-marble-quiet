...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CBgz9KRx.mjs");
...
var manifest = { "8a98787a67ec3252ae066b084b5e90936ec517b51d5bbd19d16e245a825fc902": {
	functionName: "getPriceList_createServerFn_handler",
	importer: () => import("./get-price-list-CdAzgcKJ.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Mip_sizj.mjs").then((n) => n.t),
